...
pub use wire::{
    ...
    CLI_QUICK_RETRY_MAX_ATTEMPTS, CLI_QUICK_RETRY_BASE_DELAY,
    CLI_NORMAL_RETRY_MAX_ATTEMPTS, CLI_NORMAL_RETRY_BASE_DELAY,
    CLI_PATIENT_RETRY_MAX_ATTEMPTS, CLI_PATIENT_RETRY_BASE_DELAY,
    FAST_FAIL_CONNECTION_TIMEOUT, FAST_FAIL_DNS_TIMEOUT, FAST_FAIL_HANDSHAKE_TIMEOUT,
    RetryStrategy, FailureClass,
};
