...
impl Server {
    ...
    pub async fn run(self) -> Result<()> {
        ...
        self.graceful_shutdown(active_connections, shutdown_handle).await?;
    ...
    async fn graceful_shutdown(
        ...
        info!("Waiting for {} active connections to complete", active_connections.len());
        ...
        if !active_connections.is_empty() {
            warn!("Forcing closure of {} remaining connections after timeout", 
